# Web de Sandra Fortanet

Codi font de **https://sandrafortanet.netlify.app/** — web professional sobre
llengua, lectura i intel·ligència artificial per a l'aula.

## Com es publica

Netlify està connectat a este repositori: **cada canvi que es puja a la branca
`main` es publica sol** en un minut aproximadament. No cal arrossegar fitxers ni
tocar res en Netlify. L'adreça pública no canvia mai.
...
Quan s'afig una pàgina nova, cal afegir-la també al `sitemap.xml`.

---

@sanforbel · https://sandrafortanet.netlify.app/
